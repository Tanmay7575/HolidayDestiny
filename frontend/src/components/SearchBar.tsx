...
export const SearchBar = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex">
        <button className="w-3/3 bg-blue-600 text-white h-full p-2 font-bold text-xl hover:bg-blue-500"
        >
        Search
        </button>
      </div>
       <div className="flex">
        <button className="w-3/3 bg-red-600 text-white h-full p-2 font-bold text-xl hover:bg-blue-500">
        Clear
        </button>
      </div>
    </form>
