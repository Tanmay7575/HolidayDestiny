  ...
  return (
    <div className=''>
        <div className="flex flex-col ">
            <h1 className="text-3xl font-blod mb-2">Add Hotels</h1>
        ...
        <label htmlFor="" className="text-gray-700 text-em font-bold ">
          ...
          />
           {errors.country && (
            ...
            <label  className="text-gray-700 text-em font-bold ">
            Description
          <textarea
          rows={6}
          className="border rounded w-full py-1 px-5 font-normal"
         ...
         <label htmlFor="" className="text-gray-700 text-em font-bold max-w-[50%]">
          Price Per Night
          <input
            type="number"
            min={1}
